<?php
    ...
    Description: Create a custom social media feed in seconds! Add the widget to your theme, or create a Social Feed on ANY page or post by using the shortcode [powr-social-feed]. Then, simply visit your site and click the settings icon to customize your Social Feed right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.1
