...
== Description ==
**POWr Social Feed** is a fast, simple, and easily customized plugin you can edit **right in your web page**.
Add the widget to your site, or use the shortcode **[powr-social-feed]** to add Social Feed to any post.
<br><br>
...
= How can I add Social Feed to a blog post or page? = Just add the shortcode **[powr-social-feed label='MY LABEL']** (including the brackets) in your post where you'd like your Social Feed to appear. Then visit your page!

= How can I add  Social Feed to my site multiple times? = Just be sure to specify different label text, eg **[powr-social-feed label='MY LABEL 1']**, **[powr-social-feed label='MY LABEL 2']** for each time you use the plugin
